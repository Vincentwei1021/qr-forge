      ...
      <main className="px-4 py-12 sm:px-6 sm:py-16">
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-gray-700 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Minimum Size Requirements</h2>
            <p>
              The most common reason QR codes fail to scan is that they&apos;re printed too small. As a rule of thumb, your QR code should be at least <strong>2 cm × 2 cm (about 0.8 × 0.8 inches)</strong> for a scan distance of roughly 20 cm (arm&apos;s length). For larger scan distances — like a poster or storefront sign — scale proportionally.
            </p>
            <p>
              A practical formula: <strong>minimum size = scan distance ÷ 10</strong>. For a sign scanned from 1 meter away, your QR code should be at least 10 cm × 10 cm.
            </p>
            <p>
              When printing, always download your QR code as an SVG file from <Link href="/" className="text-indigo-600 hover:underline">QR Forge</Link>. SVG is vector-based, so it scales to any size without the pixelation that ruins small PNG prints.
            </p>

            <h2 className="text-2xl font-bold text-gray-900">Contrast Is Non-Negotiable</h2>
            <p>
              QR codes rely on the scanner distinguishing dark modules (squares) from a light background. The higher the contrast, the faster and more reliable the scan. The standard is <strong>dark modules on a white or very light background</strong>.
            </p>
            <p>
              Avoid these common mistakes:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Light-on-dark:</strong> White code on a dark background can work, but requires testing. Many scanners struggle with inverted QR codes.</li>
              <li><strong>Low contrast colors:</strong> Yellow on white, light gray on white, or dark blue on black — all problematic. Aim for at least 4:1 contrast ratio.</li>
              <li><strong>Busy backgrounds:</strong> Placing a QR code over a photograph or complex pattern dramatically reduces scan reliability.</li>
            </ul>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900">Error Correction Levels</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Level L (7%):</strong> Lowest redundancy, smallest code. Use for clean digital displays.</li>
              <li><strong>Level M (15%):</strong> Good balance for most uses.</li>
              <li><strong>Level Q (25%):</strong> Better for environments where codes might get scuffed or wet.</li>
              <li><strong>Level H (30%):</strong> Maximum redundancy. Use if you want to add a logo in the center of your QR code — the logo can cover up to 30% of the code and it still scans.</li>
            </ul>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900">Always Include a Quiet Zone</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900">Test Before You Print</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900">Keep the Destination URL Short</h2>
            <p>
            ...
            <div className="rounded-lg border border-indigo-200 bg-indigo-50 p-5">
              <p className="font-semibold text-indigo-800">Create your QR code the right way</p>
              <p className="mt-1 text-indigo-700">
                <Link href="/" className="underline">QR Forge</Link> generates free custom QR codes with PNG and SVG download options. No sign-up required.
              </p>
            </div>
          </div>
        </article>
